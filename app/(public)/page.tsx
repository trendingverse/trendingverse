  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="features" className="max-w-5xl mx-auto px-6 py-24">
        ...
        <p className="text-gray-500 text-center mb-16">Built for news publishers, bloggers, and content teams across India</p>
        <div className="grid md:grid-cols-3 gap-8">
          {[
            ...
            { icon: '✦', title: 'AI article generation', desc: 'Generate 700-900 word, Google Discover-ready articles in 10 Indian languages including Hindi, Tamil, Telugu and more.' },
            { icon: '📸', title: 'Auto editorial photos', desc: 'Automatically fetches relevant professional photos from Pexels and uploads to WordPress as featured image.' },
            { icon: '⬆', title: 'One-click WordPress push', desc: 'Push articles directly to your WordPress site with featured image, categories, Yoast SEO meta — all at once.' },
            { icon: '⏰', title: 'Daily auto-publish cron', desc: 'Set and forget — your site gets fresh trending content every morning without you lifting a finger.' },
            { icon: '🔑', title: 'Bring your own API key', desc: 'Use your own Gemini, ChatGPT or Claude API key for unlimited generations with zero quota limits.' },
          ].map(f => (
        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 relative">
              ...
              <div className="text-4xl font-bold text-white mb-1">₹899</div>
              <div className="text-sm text-gray-500 mb-8">per month · ~$10/mo</div>
              <ul className="space-y-3 mb-8">
                {[
                  'Unlimited articles',
              ...
              <Link href="/signup?plan=popular" className="block text-center py-3 bg-red-500 rounded-xl text-sm font-medium text-white hover:bg-red-600 transition-colors">
                Get Popular plan
              </Link>
            </div>

            {/* BYOAK */}
            <div className="bg-white border-2 border-teal-400 rounded-2xl p-8 relative">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-teal-500 text-white text-xs font-medium px-3 py-1 rounded-full">Power publishers</div>
              <div className="text-sm font-medium text-teal-600 mb-2">Pro + Own Keys</div>
              <div className="text-4xl font-bold text-gray-900 mb-1">₹499</div>
              <div className="text-sm text-gray-400 mb-8">per month · ~$6/mo</div>
              <ul className="space-y-3 mb-8">
                {[
                  'Everything in Popular',
                  'Your own Gemini key',
                  'Your own ChatGPT key',
                  'Your own Claude key',
                  'Zero quota limits',
              ...
              <Link href="/signup?plan=byoak" className="block text-center py-3 bg-teal-500 rounded-xl text-sm font-medium text-white hover:bg-teal-600 transition-colors">
                Get Pro + Own Keys
              </Link>
            </div>
          ...
          <div className="mt-10 p-5 bg-white border border-gray-100 rounded-2xl text-center">
            <p className="text-sm text-gray-600">
              💡 <strong>Pro + Own Keys</strong> is cheaper because you bring your own AI quota —
              perfect for high-volume publishers who already have API access.
              Payments via <span className="font-medium">Razorpay</span> · UPI · Cards · Net Banking accepted.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-gray-100 py-8 text-center text-sm text-gray-400">
        © {new Date().getFullYear()} TrendingVerse CMS · Built for Indian publishers
      </footer>
    </div>
  )
}
